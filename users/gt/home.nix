...
in
{
  ...
  programs.ssh = {
    enable = true;
    # Keep default config but add your customizations
    extraConfig = ''
      IdentitiesOnly yes
  ...
  programs.git = {
    ...
    extraConfig = {
      ...
      # Remove the core.sshCommand line as it's handled by your SSH config
    };
    aliases = {
      st = "status";
      co = "checkout";
  ...
  home.sessionVariables = {
    ...
    PAGER  = "less";
    MANPAGER = "less";
    # Remove GIT_SSH_COMMAND as it's handled by SSH config
  };
}
